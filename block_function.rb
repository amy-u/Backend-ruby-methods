...
# 9 to a block, and then will print out the result.  Call the do_calc function twice in your program. The first time,
# pass a block that adds the two numbers. The second time,
